...
class TableModule extends CModule
{
	...
	protected function show(&$options=array())
	{
		...
		$nooptmenu = isset($this->_attribs['nooptmenu'])?intval($this->_attribs['nooptmenu']):0;
		...
		$comname = isset($this->_attribs['comname'])?$this->_attribs['comname']:(is_component($modname)?$modname:$options['component']);
