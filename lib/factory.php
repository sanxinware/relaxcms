...
class Factory
{
	...
	static function &GetTemplate($name="default")
	{
		return CTemplate::GetInstance($name);
	}
	...
	static function getModInfoList()
	{
		$app = Factory::GetApp();
		if ($app) {
			return$app->getModInfoList();
		}
		return false;
	}
	...
	*/
	...
	static function &GetImage($imageRef=null)
	{
		static $instance = null;		
		if (!is_object( $instance )) 
		{
			$instance = new CImage($imageRef);
		}		
		return $instance;
	}
	...
	static function &GetInstallation()
	{
		static $instance = null;		
		if (!is_object( $instance )) {
			$instance = new CInstallation();
		}		
		return $instance;
	}	
	...
	static function &GetOpenPlatform($name='', $options=array())
	{
		return COpenPlatform::GetInstance($name, $options);
	}
	...
	static function &GetOcr($name, $options=array())
	{
		return COcr::GetInstance($name, $options);
	}
	...
	static function &GetDocument($name="default")
	{
		return CDocument::GetInstance($name);
	}
}