...
define( 'RPATH_OPENPLATFORM',		RPATH_LIB.DS.'openplatform');
define( 'RPATH_SMS',				RPATH_LIB.DS.'sms');
...
define( 'RPATH_LIBMODULES', 		RPATH_LIB.DS."modules" );
define( 'RPATH_LIBTEMPLATES', 		RPATH_LIB.DS."templates" );
...
define( 'RPATH_DATA',				RPATH_ROOT.DS.'data');

//default template dir
define( 'RPATH_TEMPLATE_DEFAULT',	RPATH_TEMPLATES.DS.'default');
define( 'RPATH_LIBTEMPLATE_DEFAULT',RPATH_LIBTEMPLATES.DS.'default');

//public name
$pdir = RPATH_BASE;
while(1) {
	if (is_file($pdir.DS.'static'.DS.'js'.DS.'admin.js')){
		break;		
	}
	if (is_file($pdir.DS.'lib'.DS.'base.php')) {
...
define( 'RPATH_THEME',				RPATH_PUBLIC.DS.'src');
define( 'RPATH_PUBDATA',			RPATH_PUBLIC.DS.'data');
define( 'RPATH_DOCUMENTS',			RPATH_PUBLIC.DS.'docs');
define( 'RPATH_DOWNLOAD',			RPATH_PUBLIC.DS.'download');
